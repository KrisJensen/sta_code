...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 2:
        ...
        base_model_name = "MazeEnv_L4_max6/landscape_changing-rew_dynamic-rew_constant-maze/allo_planrew_plan5-6-7/VanillaRNN/iter10_tau5_opt/N800_linout/model21"
